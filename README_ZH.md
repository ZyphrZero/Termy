...
- 从 Termy 启动的 Agent CLI 会通过环境变量收到轻量的上下文快照路径；Codex CLI 与 OpenCode 内置启动器会用短 prompt 指向上下文说明文件。
...
- **桥接**：Claude Code IDE bridge，以及供 Codex CLI、OpenCode 和其他终端 Agent 使用的共享上下文快照。
