...
export const zhCN: TranslationKeys = {
  ...
  notices: {
    ...
    settings: {
      ...
      codexCliMcpRegistered: 'Codex CLI MCP 注册已更新',
  ...
  settingsDetails: {
    ...
    advanced: {
      ...
      claudeCodeIntegration: 'Claude Code 集成',
      codexCliIntegration: 'Codex CLI 集成',
      claudeCodeContext: 'Claude Code 上下文感知',
      claudeCodeContextDesc: 'Termy 会将当前 Obsidian 文件与选区暴露给 Claude Code，让从 Termy 启动的 Claude 会话能感知当前笔记上下文。',
      codexCliMcp: 'Codex CLI 上下文 MCP',
      codexCliMcpDesc: 'Termy 会自动注册名为“termy-context”的本地 MCP server，让 Codex CLI 能读取当前 Obsidian 文件、选区、已打开文件和仓库上下文。',
      codexCliMcpAutoRegister: '自动注册 Codex MCP',
      codexCliMcpAutoRegisterDesc: '自动在 Codex CLI 中保持“termy-context” MCP server 的注册状态。',
      codexCliMcpReregister: '立即重新注册',
      codexCliMcpReregisterDesc: '使用当前二进制路径和快照路径，强制刷新 Codex CLI 中的 termy-context MCP 注册。',
      codexCliMcpRemove: '移除注册',
