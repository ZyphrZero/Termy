...
export const zhCN: TranslationKeys = {
  ...
  settingsDetails: {
    terminal: {
      ...
      aiLauncherCategoryCodingAgentDesc: '在终端中运行的 AI 编码助手，也可作为 Agent Thread 服务使用。',
    ...
    agents: {
      heading: '自定义 Agent 服务',
      headingDesc: '为没有内置 Coding Agent 条目的 ACP 服务添加自定义启动配置。',
      addAgent: '添加服务',
      editAgent: '编辑',
      deleteAgent: '删除',
      moveUp: '上移',
      moveDown: '下移',
      resetAgent: '重置为默认',
      installAcpAdapter: '安装 ACP 适配器',
      installAcpAdapterShort: '安装',
      capabilityTerminal: 'Terminal',
      capabilityAcp: 'ACP',
      emptyCustomAgents: '没有自定义 Agent 服务。Claude Code、Codex 和 OpenCode 的 ACP 配置已显示在上方 Coding Agent 中。',
      acpAdapterStatusReady: 'ACP 就绪',
      acpAdapterStatusMissing: 'ACP 未安装',
      acpAdapterStatusChecking: '检测 ACP…',
      acpAdapterStatusUnknown: 'ACP 未知',
      acpAdapterStatusUnsupported: '不支持 ACP',
      acpAdapterTitleInstall: '安装 {{name}}',
      cannotDeleteBuiltIn: '无法删除内置 agent，请使用“禁用”代替删除',
      editAgentTitle: '编辑 agent',
  ...
  agent: {
    viewTitle: 'Agent 输出',
    headerIdle: 'Agent 面板',
    headerSubtitleIdle: '没有活动的 Agent',
    error: {
      idFormat: 'ID 必须以小写字母开头，仅包含小写字母、数字和连字符',
      idDuplicate: '已存在相同 ID 的 agent',
      commandEmpty: '命令不能为空',
      commandNpx: 'ACP agent 必须直接使用已安装命令，不能使用 npx',
      labelEmpty: '标签不能为空',
    },
    stateIdle: '空闲',
    stateRunning: '运行中',
    stateAwaitingInput: '等待输入',
    stateFinished: '已完成',
    stateErrored: '出错',
    emptyTitle: '还没有消息',
    emptyBody: '启动 Agent 或运行演示流，可在这里看到结构化输出。',
    clearTooltip: '清空对话',
    moreActions: '更多操作',
    menuClear: '清空对话',
    menuCopyTranscript: '复制对话为 Markdown',
    noticeNothingToCopy: '没有可复制的对话内容',
    noticeTranscriptCopied: '对话已复制到剪贴板',
    noticeCopyFailed: '复制对话失败',
    planTitle: '计划',
    permissionTitle: 'Agent 正在请求权限',
    errorTitle: 'Agent 错误',
    errorDetailsLabel: '查看详情',
    toolStatusPending: '待处理',
    toolStatusRunning: '运行中',
    toolStatusCompleted: '已完成',
    toolStatusFailed: '失败',
    toolStatusCancelled: '已取消',
    openCommand: 'Agent：打开输出面板',
    inputPlaceholder: '向 Agent 发送消息…',
    sendButton: '发送',
    cancelButton: '取消',
    noticeSubmitFailed: '向 Agent 发送消息失败',
    noticeAcpFailed: '连接 ACP Agent 失败：{{message}}',
    permission: {
      title: '{{agent}} 正在请求权限',
    },
    statusConnected: '{{count}} 个已连接',
    statusRunning: '{{count}} 个运行中',
    statusPending: '{{count}} 个待审批',
    terminalProvider: 'Terminal',
    terminalThreadSubtitle: '实时终端线程',
    terminalThreadSubtitleEmpty: '没有终端线程',
    terminalInputPlaceholder: '发送文本到终端...',
    terminalThreadsHeading: '线程',
    terminalThreadsRefresh: '刷新终端线程',
    terminalThreadsNewThread: '新建终端线程',
    terminalThreadsClose: '关闭终端线程',
    terminalThreadsEmptyTitle: '没有终端线程',
    terminalThreadsEmpty: '新建一个终端线程，即可在 Agent 面板中直接运行 Claude Code、Codex、OpenCode、Hermes 或任意 CLI。',
    terminalThreadsUnavailable: '当前无法使用终端线程。',
    ...
    threadRename: '重命名线程',
    threadArchive: '归档线程',
    threadRenameTitle: '重命名线程',
    threadRenamePlaceholder: '输入新的线程名称',
    threadRenamed: '线程已重命名',
    threadArchived: '线程已归档',
    sessionsHeading: '会话历史',
    sessionsRefresh: '刷新会话',
    sessionsNewSession: '新建会话',
    sessionsLoading: '正在加载会话…',
    sessionsEmpty: '暂无会话。可点击"导入线程"同步历史，或点击"新建线程"开始新对话。',
    sessionsLoadFailed: '加载会话失败：{{message}}',
    sessionsProviderUnavailable: '当前无法使用线程历史。',
    sessionsComingSoon: '即将推出',
    sessionItemUntitled: '未命名会话',
    sessionTimeJustNow: '刚刚',
    sessionTimeMinutes: '{{count}} 分钟前',
    sessionTimeHours: '{{count}} 小时前',
    sessionTimeDays: '{{count}} 天前',
    transcriptLoading: '正在加载对话内容…',
    transcriptLoadFailed: '加载对话失败：{{message}}',
    openSettings: '打开设置',
    agentRemoved: '所选 agent 已被移除或禁用',
    restartButton: '重启 agent',
  },
};
