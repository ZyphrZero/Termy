...
export const zhCN: TranslationKeys = {
  ...
  agent: {
    ...
    runDemoCommand: 'Agent：运行演示流',
    stopDemoCommand: 'Agent：停止演示流',
    noticeDemoStarted: '已开启 Agent 演示流',
    noticeDemoStopped: '已停止 Agent 演示流',
    inputPlaceholder: '向 Agent 发送消息…',
    sendButton: '发送',
    cancelButton: '取消',
    noticeSubmitFailed: '向 Agent 发送消息失败',
    connectAcpCommand: 'Agent：连接 ACP Agent（OpenCode）',
    disconnectAcpCommand: 'Agent：断开 ACP Agent',
    noticeAcpConnected: 'ACP Agent 已连接',
    noticeAcpDisconnected: 'ACP Agent 已断开',
