...
export const zhCN: TranslationKeys = {
  ...
  settingsDetails: {
    ...
    advanced: {
      ...
      agentCliIntegration: 'Agent CLI 集成',
      ...
      agentCliContextDesc: 'Termy 会在插件目录下写入轻量的 Obsidian 上下文快照，并通过 TERMY_CONTEXT_PATH 与 TERMY_CONTEXT_INSTRUCTIONS_PATH 暴露路径。内置 Agent 工作流会用短 prompt 指向这些文件，不需要 MCP 注册。',
      offlineMode: '离线模式',
