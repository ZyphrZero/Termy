...
export interface TranslationKeys {
  ...
  modals: {
    ...
    launcherInstall: {
      ...
      cardTitlePrepareWithFnm: string;
      cardTitleInstallFnm: string;
      cardDescInstall: string;
      cardDescUpgrade: string;
      cardDescUpgradeOneClick: string;
      cardDescPrepareWithFnm: string;
      cardDescInstallFnm: string;
      runtimeTitle: string;
      runtimeDescNpmReady: string;
      runtimeDescFnmReady: string;
      runtimeDescFnmMissing: string;
